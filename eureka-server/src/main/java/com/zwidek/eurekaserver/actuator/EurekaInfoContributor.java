package com.zwidek.eurekaserver.actuator;
...
@Component
public class EurekaInfoContributor implements InfoContributor {

    private final BuildProperties buildProperties;

    private final String APP_NAME = "EUREKA";

    @Autowired
    public EurekaInfoContributor(BuildProperties buildProperties) {
