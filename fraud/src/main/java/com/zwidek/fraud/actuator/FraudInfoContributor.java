package com.zwidek.fraud.actuator;
...
@Component
public class FraudInfoContributor implements InfoContributor {

    private final BuildProperties buildProperties;

    private final String APP_NAME = "FRAUD";

    @Autowired
    public FraudInfoContributor(BuildProperties buildProperties) {
